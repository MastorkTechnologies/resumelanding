  ...
  return (
    <div>
      <h5 className="formSection">
        <PersonCheck color="#027AC0" size={40} /> &nbsp;Personal Details
      </h5>
      <form onSubmit={handleLogDetails}>
        ...
        <h5 className="formSection">
          <PenFill color="#027AC0" size={24} /> &nbsp;Professional Summary{" "}
        ...
        <h5 className="formSection">
          <JournalBookmarkFill color="#027AC0" size={26} /> &nbsp;Employment
          History
        </h5>
        <p className="detailsSubText">
                    ...
                    <div key={index} className="employmentHistoryDiv">
                      ...
                      <div className="row">
                        {index > 0 && (
                          ...
                          >
                            <CaretUpSquareFill color="#027AC0" size={22} />
                          </button>
                        )}
                        {index < personalData.employmentHistory.length - 1 && (
                          ...
                          >
                            <CaretDownSquareFill color="#027AC0" size={22} />
                          </button>
                        )}
        ...
        <h5 className="formSection">
          <JournalCheck color="#027AC0" size={26} /> &nbsp;Education
        </h5>
        <p className="detailsSubText">
        ...
        <h5 className="formSection">
          <Link45deg color="#027AC0" size={26} /> &nbsp;Websites and Links
        </h5>
        <p className="detailsSubText">
                    ...
                    <div key={index} className="websitesLinksDiv">
                      ...
                      <div className="row" style={{ position: "relative" }}>
                        {index > 0 && (
                          ...
                          >
                            <CaretUpSquareFill color="#027AC0" size={20} />
                          </button>
                        )}
                        {index < personalData.websitesAndLinks.length - 1 && (
                          ...
                          >
                            <CaretDownSquareFill color="#027AC0" size={20} />
                          </button>
                        )}
